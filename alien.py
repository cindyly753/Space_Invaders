...
class AlienFleet:
    alien_exploding_images = [pg.image.load(f'images/Teleportation{n+1}.png') for n in range(9)]
    ...
    alien_images = [[pg.transform.rotozoom(pg.image.load(f'images/alien_{m}{n}.png'), 0, 1) for n in range(7)] for m in range(3)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'images/Bao_Bun{n+1}.png'), 0, 1) for n in range(7)]
