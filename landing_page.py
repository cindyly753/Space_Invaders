...
class LandingPage:
    ...
    def __init__(self, game):
        ...
        strings = [(' ', WHITE, headingFont), (' ', GREEN, subheadingFont),
    ...
    def draw_background(self):
        Universe_img = pg.image.load(f'images/Universe.jpg')
        Title_img = pg.image.load(f'images/Title.png')
        self.screen.blit(Universe_img, (0, 0))
        self.screen.blit(Title_img, (420, 50))
