...
class Sound:
    def __init__(self):
        pg.mixer.init()
        self.alien_phaser = pg.mixer.Sound('sounds/alien_fire.wav')
        self.ship_photon = pg.mixer.Sound('sounds/ship_fire.wav')
        ...
        self.end_theme = pg.mixer.Sound('sounds/Victory.wav')
        self.ufo = pg.mixer.Sound('sounds/bao_bunufo.wav')
    ...
    def play_bg(self): self.play_music('sounds/normal_speed.wav')
