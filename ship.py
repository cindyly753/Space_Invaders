...
class Ship(Sprite):
  exploding_images = [pg.image.load(f'images/Explosion{n + 1}.png') for n in range(11)]
  images = [pg.image.load(f'images/hero1.png') for n in range(1)]
  ...
  def __init__(self, game):
    ...
    self.image = pg.image.load('images/hero1.png')
